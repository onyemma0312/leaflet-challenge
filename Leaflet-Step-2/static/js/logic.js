//First, create the tile layers. One for our grayscale background.

var usgsmap = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
...
var map = L.map("mapid", {
  ...
  zoom: 2,
  layers: [usgsmap, streetsmap, outdoors]
});

// Adding the 'usgsmap' tile layer to the map.
usgsmap.addTo(map);
...
// Define an object that contains all of the different map choices. Only one of these maps will be visible at a time!
var baseMaps = {
  Satellite: streetsmap,
  Grayscale: usgsmap,
  Outdoors: outdoors
};

// Define an object that contains all of our overlays. Any combination of these overlays may be visible at the same time!
var overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson", function(data) {
  ...
  // then, add a GeoJSON layer to the map once the file is loaded.
  L.geoJson(data, {
  ...
  // Then make an AJAX call to get our Tectonic Plate geoJSON data.
